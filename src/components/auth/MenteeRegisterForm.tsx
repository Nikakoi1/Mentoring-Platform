...
export function MenteeRegisterForm() {
  ...
  const { t } = useTranslations({
    ...
    defaults: {
      ...
      'subtitle': 'Connect with experienced mentors and grow your skills',
      'labels.fullName': 'Full Name',
      'labels.email': 'Email',
      'labels.password': 'Password',
      'labels.region': 'Region',
      'cta.loading': 'Creating Account...',
      'cta.submit': 'Create Mentee Account',
      'footer.prompt': 'Already have an account?',
      'footer.link': 'Sign in',
      'success': 'Registration successful! Please check your email to verify your account.',
      // Georgian defaults
      'ka.title': 'რეგისტრაცია მოსწავლედ',
      'ka.subtitle': 'დაუკავშირდით გამოცდილ მენტორებს და განავითარეთ თქვენი უნარები',
